...
namespace RestClientTest
{
    public class AwsAuthenticator : IAuthenticator
    {
        ...
        private void SetXApiKeyHeader(RestSharp.IRestRequest request)
        {
            request.AddHeader("x-api-key", "bDJ8R50GIQ8ZU9WB124kjaBrtXCngeZ34w5nVF4M");
        }
